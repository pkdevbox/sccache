...
@SCDoc
(
	description = "Dump statistics back to the client (short version).",
	parameters = {}
)
public abstract class SCCommandDumpStatsBase implements SCCommand
{
	protected SCCommandDumpStatsBase(boolean verbose)
	{
		fVerbose = verbose;
	}
